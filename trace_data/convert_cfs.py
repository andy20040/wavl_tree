...
try:
    ...
    sys.exit(1)
output = "#ifndef _CFS_DATA_H\n#define _CFS_DATA_H\n\n"
output += "struct cfs_trace_op {\n    int is_insert;\n    unsigned long long key;\n};\n\n"
output += "static struct cfs_trace_op cfs_trace_data[] = {\n"
...
output += "};\n\n"
output += f"#define CFS_TRACE_SIZE {count}\n"
output += "#endif // _CFS_DATA_H\n"
